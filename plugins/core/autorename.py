...
from plugins.core.utils import progress_for_pyrogram, humanbytes, convert
...
# Example Usage:
filename = "Naruto Shippuden S01 - EP07 - 1080p [Dual Audio] @Wizard_Bots.mkv"
...
# Check whether the file is already being renamed or has been renamed recently
    ...
    if episode_number:
        ...
        caption = c_caption.format(filename=new_file_name, duration=convert(duration)) if c_caption else f"**{new_file_name}**"
